...
namespace TempLite
{
    class info
    {
        public class infomation
        {
            ...
            public Color ch1_u_L = new Color();
            public Color ch1_l_L = new Color();
            public Color ch2_u_L = new Color();
            public Color ch2_l_L = new Color();
            public Color ch1_max_min = new Color();
            public Color ch2_max_min = new Color();
            public Color temp_line = new Color();
            public Color rh_line = new Color();
            public Color graph_paint = new Color();
